...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/06/24 13:25:21 by arthur            #+#    #+#             */
/*   Updated: 2021/06/24 13:30:25 by arthur           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char	**get_texture_buffer(void)
{
...
t_game	init_game(void)
{
	...
	new.textures = load_texture(&new, get_texture_buffer(), 14);
	return (new);
}
